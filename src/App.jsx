  ...
  <div className="bg-paul-100 container mx-auto py-8 flex flex-col w-2/3 print:w-full">
    <div className="col-span-4 sm:col-span-3">
      <div className="flex flex-col items-center">
        ...
        <div>
          <a
            className="m-1 text-paul-700 underline"
    ...
    <p>
      ...
      cross-functional teams, drawing on diverse perspectives to create products and services
      that not only meets but exceeds expectations. I want to learn, grow, and
      contribute my skills in a way that make a meaningful impact.
    </p>
      ...
      >
        ...
        <div className="mt-4 justify-left select-none flex">
          {p.tech.map((t) => (
            <div
              key={t}
              className="py-1 px-3 mr-2 no-underline rounded-full bg-paul-400 text-paul-800 text-sm "
            >
              {t}
            </div>
          ))}
